    ...
    public class Heap
    {
        ...
        private void heapifyUp(int i)
        {
            while (i > 0)
            {
                ...
                if (esMaxHeap)
                {
                    if (elementos[i].ocurrencia > elementos[padre].ocurrencia) condicion = true;
                }
                else
                {
                    if (elementos[i].ocurrencia < elementos[padre].ocurrencia) condicion = true;
        ...
        private void heapifyDown(int i)
        {
            ...
            while (true)
            {
                ...
                if (izq < n)
                {
                    if (elementos[izq].ocurrencia > elementos[candidato].ocurrencia) candidato = izq;
                }

                if (der < n)
                {
                    if (elementos[der].ocurrencia > elementos[candidato].ocurrencia) candidato = der;
                }

                if (candidato == i) break;
